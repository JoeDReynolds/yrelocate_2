...
mongo = app.config['pymongo_db']


print('from routes.py')
...
def population():
    ...
    projects = models.retrive_population_data(mongo)
    json_projects = []
...
def housing():
    print("---------------housing-----------------")
    # Get the Data from MongoDc
    housedata = models.retrive_housing_data(mongo)
    json_housing = []
...
def school():
    print("---------------elementary-----------------")
    # Get the Data from MongoDc
    schooldata = models.retrive_elementary_data(mongo)
    json_elementary = []
...
def highschool():
    print("---------------highschool-----------------")
    # Get the Data from MongoDc
    highschooldata = models.retrive_highschool_data(mongo)
    json_highschool= []
...
def middleschool():
    print("---------------middleschool-----------------")
    # Get the Data from MongoDc
    midschooldata = models.retrive_middleschool_data(mongo)
    json_midschool= []
